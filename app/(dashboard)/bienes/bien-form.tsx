...
import { crearBien, actualizarBien } from "./actions";
...
export function BienForm({
  ...
  // Cuando selecciona tipo de bien, auto-completar nombre con la descripción
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  form.setValue("id_sede", Number(val))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  form.setValue("id_area", Number(val))
                }
              >
                <SelectTrigger>
